					...
					<Row className="d-flex justify-content-center justify-content-md-start" >
						<Card variant="primary" style={{ width: '300px' }}>
							<Card.Body>
								...
								<Card.Subtitle className="mb-2 text-muted">по Москве</Card.Subtitle>
								<Card.Text>
									Доставка от 5000 р. по г.Москве и МО бесплатна
								</Card.Text>
								<Card.Subtitle className="mb-2 text-muted">По России</Card.Subtitle>
								<Card.Text>
